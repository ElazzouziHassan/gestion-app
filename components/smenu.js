...
const SMenu = () => {
  ...
  const menuItems = [
    { id: '1', name: "Accueil", icon: "home", link: "/students/home" },
    { id: '2', name: "Profil", icon: "person", link: "/students/profile" },
    { id: '3', name: "Emploi", icon: "calendar-today", link: "/students/schedules" },
    { id: '4', name: "Module", icon: "school", link: "/students/modules" },
  ];
  ...
  const handlePressIn = (id) => {
    Vibration.vibrate(10); // Retour haptique léger
